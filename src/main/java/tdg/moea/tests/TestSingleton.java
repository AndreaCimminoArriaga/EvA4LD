...
public class TestSingleton {
	...
	public static void main(String[] args) throws Exception {
		...
		KFoldEvaluator.DEFAULT_THREAD_POOL_SIZE = 1;//Runtime.getRuntime().availableProcessors();	// given a kFoldSize, the number of referenceLinks that can be retrieved and stored in parallel
		...
		String referenceLinksSize = "1600";//args[4].trim();
		
		
		runOverEnvironment(environmentFile, algorithm, folds, "1", Integer.valueOf(setupNumberStr), referenceLinksSize);
